using Capitulo1.Areas.Docente.Models;
using Capitulo1.Data;
using Capitulo1.Data.DAL.Cadastro;
using Capitulo1.Data.DAL.Docente;
...
namespace Capitulo1.Areas.Docente.Controllers
{
    [Area("Docente")]
    public class ProfessorController : Controller
    {
        ...
        public IActionResult AdicionarProfessor()
        {
            PrepararViewBags(instituicaoDAL.ObterInstituicoesClassificadasPorNome().ToList(),
               departamentoDAL.ObterDepartamentosClassificadosPorNome().ToList(),
               cursoDAL.ObterCursosClassificadosPorNome().ToList(),
